...
_SYSTEM_PROMPT = (
    ...
    "4. Screens: call list_media first; if on-brand content exists show "
    "it with set_screen_content, otherwise put the client's name on "
    "screen as text. Never invent file names.\n"
