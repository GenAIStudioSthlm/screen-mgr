...
_SYSTEM_PROMPT = (
    ...
    "1. Recall that client's brand identity from what you know — a "
    "primary brand color as #RRGGBB plus the overall mood (e.g. IKEA = "
    "blue #0051BA with yellow #FFDA1A accents). If unsure of the exact "
    "color, use a faithful approximation and say so.\n"
    "2. Lighting: set the Studio (and Maker) groups to the brand's "
    "primary color at a comfortable brightness via set_group(color_hex=).\n"
