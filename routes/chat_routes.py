...
_SYSTEM_PROMPT = (
    ...
    "5. Then tell the operator what you set in one or two lines, and flag "
    "anything you couldn't do (e.g. LED panels have no brand-color "
    "control yet, or there's no logo on disk).\n"
