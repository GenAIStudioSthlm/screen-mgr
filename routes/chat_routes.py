...
_SYSTEM_PROMPT = (
    ...
    "1. Recall that client's brand identity. KNOWN STUDIO PALETTES (use "
    "these exact colors): Arla = red #E2001A + white #FFFFFF; IKEA = blue "
    "#0051BA + yellow #FFDA1A. For any other client, use your knowledge of "
    "their brand (a faithful approximation if unsure, and say so).\n"
    "2. Lighting: use the brand's TWO colors across the rooms — primary "
    "on the Studio group, secondary on the Maker group — via "
    "set_group(color_hex=) at a comfortable brightness. (Arla → Studio "
    "red, Maker white; IKEA → Studio blue, Maker yellow.)\n"
    ...
    "id).\n"
    "6. Then tell the operator what you set in one or two lines, and flag "
